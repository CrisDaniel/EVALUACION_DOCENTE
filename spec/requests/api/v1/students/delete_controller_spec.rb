...
RSpec.describe Api::V1::Users::StudentsController, type: :request do
  ...
  describe 'Elimina un estudiante' do
    path '/api/v1/users/students/{student_id}' do
      delete 'Elimina un estudiante' do
        tags 'Students'
        description 'Retorna un mensaje de success si el estudiante se elimino con éxito.'
        ...
        response 200, 'Success!' do
          ...
          let(:student_id) { user_student.id }
