...
RSpec.describe Api::V1::CoursesController, type: :request do
  ...
  describe 'Retorna la lista de Cursos' do
    path '/api/v1/courses' do
      get 'Retorna una lista de Cursos' do
        tags 'Courses'
        description 'Retorna una lista de todos los cursos y pueden ser filtrados por: <br/><br/> q = este es el search que busca por "name" <br/><br/> order_by = ordena por el campo "name" y soport "ASC" y "DESC" <br/><br/> page = Numero de pagina a mostrar'
