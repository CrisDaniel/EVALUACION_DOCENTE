...
export default function EditTeachers(){
  ...
  function handleSubmit(e) {
    e.preventDefault();
      ...
      Axios({
        method: 'patch',
        url: `/api/v1/users/${dataTeacher.id}` ,
  ...
  return (
    <div className="w-full h-full">
      <div className="my-10 mx-auto max-w-3xl">
        <h1 className='text-lg md:text-2xl font-semibold'>Actualizar Docente: {teacher_id}</h1>
        <p className='text-sm md:text-base text-gray-500'>Edita los datos del docente.</p>
      </div>
      <form onSubmit={handleSubmit} className="pt-8 px-8 max-w-3xl mx-auto rounded-lg bg-white border shadow-md">
            ...
            <div className="mt-4 w-full overflow-x-auto">
              ...
              <table className="mt-2 divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th scope="col" className="py-2 text-xs font-medium text-center text-gray-500 uppercase tracking-wider">
                      Código
                    </th>
                    <th scope="col" className="py-2 text-xs font-medium text-center text-gray-500 uppercase tracking-wider">
                      Nombre
                    </th>
                    <th scope="col" className="py-2 text-xs font-medium text-center text-gray-500">
                      -
                    </th>
                  </tr>
                </thead>
