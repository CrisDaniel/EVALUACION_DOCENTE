...
export default function NewStudent(){
  ...
  function handleListCourse(event){
    ...
    <section className="flex justify-around">
      <div className="w-3/4 mt-9">
        <div className="flex flex-col mb-6 ">
          ...
          <p className="text-sm text-gray-500">Llena los datos indicados para crear un nuevo alumno.</p>
        </div>
              ...
              <form method="POST" onSubmit={handleSubmit}>
                <div className="shadow overflow-hidden sm:rounded-md">
                  ...
                  <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    ...
                    <button
                      type="submit"
                      className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm ml-4 text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                      Crear Alumno
                    </button>
                  </div>
